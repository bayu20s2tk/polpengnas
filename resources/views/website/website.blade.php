...
<html lang="en">
    <head>
        ...
        <link rel='stylesheet' href='/css/fonts/vendor/@fortawesome/fontawesome-free/kingster-style-custom.css' type='text/css' media='all' />
    ...
    <!-- <body id="top" class="d-flex flex-column align-items-end"> -->
       ...
       <!-- <div class="back-to-top-box fixed-bottom">
            <a href="#top" class="back-to-top animate jumper btn btn-primary" data-icon="">BACK TO TOP</a>
        </div> -->
